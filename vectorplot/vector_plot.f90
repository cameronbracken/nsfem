...
!
  ...
  integer, allocatable, dimension ( : ) :: thin_dex
...
!  write ( *, '(a)' ) '  2.0 = double length.'
	...
	open(11,file='scaling')
  read ( 11, * ) velocity_scale,thin_factor
!
...
!
!    Output, integer IERROR, nonzero on error.
!
  implicit none
...
!
!    Output, integer THIN_NUM, the number of vectors remaining after
!    thinning.
!
